globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/tanishq_rocks/Desktop/ADResume/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/tanishq_rocks/Desktop/ADResume/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/tanishq_rocks/Desktop/ADResume","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/tanishq_rocks/Desktop/ADResume/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/tanishq_rocks/Desktop/ADResume/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/tanishq_rocks/Desktop/ADResume/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _YjaPzERhNL = (function(nitro) {
...
const _lazy_kacUhi = () => Promise.resolve().then(function () { return about$1; });
const _lazy_6ezTHE = () => Promise.resolve().then(function () { return categories$1; });
const _lazy_5fboeG = () => Promise.resolve().then(function () { return projects$1; });
const _lazy_HcI5Fb = () => Promise.resolve().then(function () { return services$1; });
const _lazy_nyrSe2 = () => Promise.resolve().then(function () { return testimonials$1; });
const _lazy_tuwoo8 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/about', handler: _lazy_kacUhi, lazy: true, middleware: false, method: undefined },
  { route: '/api/categories', handler: _lazy_6ezTHE, lazy: true, middleware: false, method: undefined },
  { route: '/api/projects', handler: _lazy_5fboeG, lazy: true, middleware: false, method: undefined },
  { route: '/api/services', handler: _lazy_HcI5Fb, lazy: true, middleware: false, method: undefined },
  { route: '/api/testimonials', handler: _lazy_nyrSe2, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_tuwoo8, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_tuwoo8, lazy: true, middleware: false, method: undefined }
];
  ...
  return [
    {
      ...
      url: "https://s3-ap-south-1.amazonaws.com/static.awfis.com/wp-content/uploads/2017/07/07184649/ProjectManagement.jpg"
    }
  ];
});
...
const services$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: services
});
...
const testimonials$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const getClientManifest = () => import('/Users/tanishq_rocks/Desktop/ADResume/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/tanishq_rocks/Desktop/ADResume/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
